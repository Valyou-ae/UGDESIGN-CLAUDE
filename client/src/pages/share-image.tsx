        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/">
            <Button variant="ghost" className="gap-2 text-muted-foreground hover:text-foreground" data-testid="link-back-home">
              <ArrowLeft className="w-4 h-4" />
              <span className="font-bold text-xl text-[#f8991c]">UGLI</span>
            </Button>
          </Link>
          <Link href="/image-gen">
            <Button className="gap-2 bg-[#f8991c] hover:bg-[#A04228] text-white" data-testid="button-create-own">
      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <Link href="/image-gen">
              <Button className="w-full gap-2 bg-[#f8991c] hover:bg-[#A04228] text-white" data-testid="button-try-ugli">
                <Sparkles className="w-4 h-4" />
                Try UGLI for Free!
              </Button>
            </Link>
            ...
            {/* CTA Box */}
            <div className="p-6 rounded-2xl bg-gradient-to-br from-[#f8991c]/10 to-[#B8860B]/10 border border-[#f8991c]/20">
              ...
              <Link href="/">
                <Button variant="link" className="p-0 h-auto text-[#f8991c] gap-1" data-testid="link-learn-more">
