    ...
    <div className="h-screen bg-background flex font-sans text-foreground overflow-hidden">
      ...
      <main className="flex-1 flex flex-col relative h-full overflow-y-auto bg-[#FAFAFA] dark:bg-[#09090B]">
        ...
        <div className="h-32 md:h-40 w-full relative overflow-hidden flex-shrink-0">
          <div className="absolute inset-0 bg-gradient-to-r from-[#f8991c] via-[#B8860B] to-[#1A1A2E] opacity-90" />
            ...
            <div className="relative">
              <div className="rounded-full p-1 md:p-1.5 bg-background">
                <Avatar className="h-24 w-24 md:h-32 md:w-32 border-4 border-background shadow-xl">
                  ...
                  <AvatarFallback className="text-4xl bg-gradient-to-br from-[#f8991c] to-[#B8860B] text-white" data-testid="text-user-initials">
                    {initials}
                  </AvatarFallback>
                </Avatar>
              </div>
            ...
            <div className="flex-1 pt-2">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex gap-3">
                  ...
                  <Button 
                    size="sm" 
                    className="bg-gradient-to-r from-[#f8991c] to-[#D4881E] hover:shadow-lg hover:shadow-[#f8991c]/20 border-0 text-white"
