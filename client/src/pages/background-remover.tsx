...
const OUTPUT_TYPES: Array<{
  ...
  { 
    ...
    icon: Palette,
    preview: 'bg-gradient-to-br from-[#f8991c] to-[#D4881E]'
  },
  { 
    id: 'blur', 
    name: 'Blur', 
              ...
              <div className="flex-1 flex flex-col animate-fade-in gap-6">
                ...
                <div className="bg-card border border-border rounded-[16px] p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <Button 
                    ...
                    disabled={state === "processing"}
                    className="h-12 px-8 rounded-[12px] bg-gradient-to-r from-[#f8991c] to-[#D4881E] hover:from-[#D4881E] hover:to-[#6A2D1C] text-white font-bold transition-all hover:-translate-y-[1px] hover:shadow-lg hover:shadow-primary/25"
                ...
                <div className="bg-card border border-border rounded-[16px] p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button 
                        className="h-12 px-6 rounded-[12px] bg-gradient-to-r from-[#f8991c] to-[#D4881E] hover:from-[#D4881E] hover:to-[#6A2D1C] text-white font-bold"
          ...
          >
            ...
            >
              <div className="absolute top-0 left-0 w-full h-1 bg-muted overflow-hidden">
                <motion.div 
                  className="h-full bg-gradient-to-r from-[#f8991c] to-[#D4881E]"
                  initial={{ width: "0%" }}
                  animate={{ width: "100%" }}
