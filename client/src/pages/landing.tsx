...
const FEATURES = [
  {
    ...
    gradient: "from-[#F5A623] to-[#D4881E]",
  },
  {
    icon: Shirt,
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-2">
            <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-[#F5A623] to-[#B8860B] flex items-center justify-center shadow-lg shadow-[#F5A623]/20">
...
function Hero({ prompt, setPrompt, isGenerating, hasUsedFreeGeneration, error, onGenerate, onLogin }: HeroProps) {
  ...
  return (
    <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#F5A623]/5 via-transparent to-[#B8860B]/5" />
      <div className="absolute top-20 left-1/4 w-96 h-96 bg-[#F5A623]/10 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6">
            ...
            <span className="text-gradient-brand bg-gradient-to-r from-[#F5A623] to-[#B8860B] bg-clip-text text-transparent">
              AI-Powered
            </span>{" "}
            Tools
          </h1>
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-br from-[#F5A623] to-[#D4881E] rounded-3xl p-10 sm:p-16"
        >
          ...
          <Link href="/signup">
            <Button size="lg" className="bg-white text-[#F5A623] hover:bg-white/90 h-12 px-8" data-testid="button-cta-final">
