...
const FEATURES = [
  {
    ...
    gradient: "from-[#f8991c] to-[#D4881E]",
  },
  {
    icon: Shirt,
  ...
  },
  {
    ...
    gradient: "from-[#B8860B] to-[#996B08]",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-2">
            <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-[#f8991c] to-[#B8860B] flex items-center justify-center shadow-lg shadow-[#f8991c]/20">
...
function Hero({ prompt, setPrompt, isGenerating, hasUsedFreeGeneration, error, onGenerate, onLogin }: HeroProps) {
  ...
  return (
    <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#f8991c]/5 via-transparent to-[#B8860B]/5" />
      <div className="absolute top-20 left-1/4 w-96 h-96 bg-[#f8991c]/10 rounded-full blur-3xl" />
      <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-[#B8860B]/10 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6">
            ...
            <span className="text-gradient-brand bg-gradient-to-r from-[#f8991c] to-[#B8860B] bg-clip-text text-transparent">
              AI-Powered
            </span>{" "}
            Tools
          </h1>
          ...
          {TESTIMONIALS.map((testimonial, index) => (
            ...
            >
              <div className="flex gap-1 mb-4">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="h-4 w-4 fill-[#B8860B] text-[#B8860B]" />
                ))}
              </div>
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-br from-[#f8991c] to-[#D4881E] rounded-3xl p-10 sm:p-16"
        >
          ...
          <Link href="/signup">
            <Button size="lg" className="bg-white text-[#f8991c] hover:bg-white/90 h-12 px-8" data-testid="button-cta-final">
