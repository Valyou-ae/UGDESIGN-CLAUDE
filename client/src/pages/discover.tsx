...
const LazyMasonryCard = memo(function LazyMasonryCard({ item, index, onLike, onUse, onCopy }: { item: InspirationItem; index: number; onLike?: (id: string) => void; onUse?: (id: string) => void; onCopy?: (prompt: string) => void }) {
  ...
  return (
    ...
    >
      <div className="group bg-white dark:bg-[#111113] border border-[#E4E4E7] dark:border-[#1F1F23] rounded-[20px] overflow-hidden cursor-pointer hover:border-[#F5A623]/50 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(233,30,99,0.15)] transition-all duration-300">
        <div className={cn("relative overflow-hidden", aspectClasses[item.aspectRatio])}>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4">
            ...
            <div className="flex items-center gap-2 mt-1.5">
              <div className="w-5 h-5 rounded-full bg-gradient-to-tr from-[#F5A623] to-[#B8860B]" />
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className={cn(
                  ...
                  remixed 
                    ? "text-[#F5A623]" 
                    : "text-[#71717A] dark:text-[#52525B] hover:text-[#F5A623]"
                )}
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <button
                      ...
                      className="flex items-center gap-1 text-xs text-[#71717A] dark:text-[#52525B] hover:text-[#F5A623] transition-colors"
                  ...
                  <PopoverContent className="w-48 p-2" align="end" onClick={(e) => e.stopPropagation()}>
                    <div className="flex flex-col gap-1">
                      <button
                        ...
                        className="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-[#F5A623]/10 transition-colors text-left"
        ...
        <div className="px-4 md:px-8 lg:px-12 py-6 max-w-[1600px] mx-auto w-full">
          <div className="flex items-center justify-between gap-3 mb-6">
            ...
            <div className="relative w-full max-w-xs">
              ...
              <Input
                ...
                className="pl-9 pr-9 h-10 bg-white dark:bg-[#111113] border-[#E4E4E7] dark:border-[#1F1F23] rounded-full text-sm focus:border-[#F5A623] focus:ring-[#F5A623]/20"
          ...
          {isLoadingCommunity ? (
            ...
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <button
                onClick={() => setSearchQuery("")}
                className="mt-4 px-4 py-2 text-sm font-medium text-[#F5A623] hover:bg-[#F5A623]/10 rounded-full transition-colors"
