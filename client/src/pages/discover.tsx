            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className={cn(
                  ...
                  remixed 
                    ? "text-[#f8991c]" 
                    : "text-[#71717A] dark:text-[#52525B] hover:text-[#f8991c]"
                )}
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <button
                      ...
                      className="flex items-center gap-1 text-xs text-[#71717A] dark:text-[#52525B] hover:text-[#f8991c] transition-colors"
                  ...
                  <PopoverContent className="w-48 p-2" align="end" onClick={(e) => e.stopPropagation()}>
                    <div className="flex flex-col gap-1">
                      <button
                        ...
                        className="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-[#f8991c]/10 transition-colors text-left"
        ...
        <div className="px-4 md:px-8 lg:px-12 py-6 max-w-[1600px] mx-auto w-full">
          <div className="flex items-center justify-between gap-3 mb-6">
            <div className="flex items-center gap-3">
              <TrendingUp className="h-5 w-5 text-[#f8991c]" />
            ...
            <div className="relative w-full max-w-xs">
              ...
              <Input
                ...
                className="pl-9 pr-9 h-10 bg-white dark:bg-[#111113] border-[#E4E4E7] dark:border-[#1F1F23] rounded-full text-sm focus:border-[#f8991c] focus:ring-[#f8991c]/20"
          ...
          {isLoadingCommunity ? (
            <div className="flex flex-col items-center justify-center py-20">
              <Loader2 className="h-8 w-8 animate-spin text-[#f8991c] mb-4" />
            ...
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <button
                onClick={() => setSearchQuery("")}
                className="mt-4 px-4 py-2 text-sm font-medium text-[#f8991c] hover:bg-[#f8991c]/10 rounded-full transition-colors"
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end" className="w-40">
                            <DropdownMenuItem
                              onClick={() => {
                                const shareUrl = `${window.location.origin}/share/${selectedItem.id}`;
                                const text = `Check out this amazing AI-generated image!`;
                            ...
                            <DropdownMenuItem
                              onClick={() => {
                                const shareUrl = `${window.location.origin}/share/${selectedItem.id}`;
                                const text = `Check out this amazing AI-generated image! ${shareUrl}`;
                            ...
                            <DropdownMenuItem
                              onClick={() => {
                                const shareUrl = `${window.location.origin}/share/${selectedItem.id}`;
                                const text = `Check out this amazing AI-generated image!`;
                                window.open(`https://pinterest.com/pin/create/button/?url=${encodeURIComponent(shareUrl)}&description=${encodeURIComponent(text)}&media=${encodeURIComponent(selectedItem.image)}`, "_blank");
                              }}
