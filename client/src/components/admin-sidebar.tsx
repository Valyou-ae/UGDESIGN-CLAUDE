  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className={cn("flex items-center gap-3 px-4 py-6 h-[88px]", collapsed ? "justify-center px-2" : "")}>
        <div className="h-10 w-10 min-w-[40px] rounded-xl bg-gradient-to-br from-[#f8991c] to-[#B8860B] flex items-center justify-center shadow-lg shadow-[#f8991c]/20">
      ...
      <div className={cn(
        ...
        <div className="relative flex-shrink-0">
          <div className="absolute -inset-0.5 bg-gradient-to-br from-[#f8991c] to-[#B8860B] rounded-full opacity-70" />
      ...
      <div className={cn("pt-4 mt-auto px-3 pb-6", collapsed ? "flex flex-col items-center" : "")}>
        <div className={cn(
          "p-4 rounded-xl bg-gradient-to-br from-[#f8991c]/10 to-[#B8860B]/10 border border-[#f8991c]/20",
          collapsed && "p-2"
        )}>
          {!collapsed ? (
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-[#f8991c] to-[#B8860B] flex items-center justify-center">
                <LayoutDashboard className="h-5 w-5 text-white" />
              </div>
              <div>
            ...
            <TooltipProvider delayDuration={0}>
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-[#f8991c] to-[#B8860B] flex items-center justify-center cursor-pointer">
