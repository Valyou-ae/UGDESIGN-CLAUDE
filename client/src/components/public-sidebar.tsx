    ...
    <div className="md:hidden fixed bottom-0 left-0 right-0 h-[60px] bg-background border-t border-border z-50 flex items-center justify-around px-2 pb-safe">
      ...
      <Link href="/image-gen">
        <div className="flex flex-col items-center justify-center -mt-6 cursor-pointer">
           <div className="h-14 w-14 rounded-full bg-gradient-to-br from-[#F5A623] to-[#B8860B] flex items-center justify-center shadow-lg shadow-[#F5A623]/30 border-4 border-background">
      ...
      >
        <div className="h-6 w-6 rounded-full bg-gradient-to-br from-[#F5A623] to-[#B8860B] flex items-center justify-center">
                      ...
                      >
                        ...
                        {item.badge && (
                          <span className={cn(
                            ...
                            isDiscover 
                              ? "bg-gradient-to-r from-[#F5A623] to-[#B8860B] text-white"
      ...
      <nav className="space-y-1 px-3" data-testid="nav-account">
        {isLoading ? (
          ...
          collapsed ? (
            ...
            >
              <div className="h-5 w-5 rounded-full bg-gradient-to-br from-[#F5A623] to-[#B8860B] flex items-center justify-center group-hover:scale-110 transition-transform">
