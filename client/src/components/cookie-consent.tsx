...
export function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-charcoal-900/95 backdrop-blur-lg border-t border-white/10 shadow-2xl">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex-1 text-sm text-charcoal-300">
          <p className="mb-2">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2 text-sm text-charcoal-300 hover:text-white border border-charcoal-600 rounded-lg hover:bg-charcoal-800 transition-colors"
          >
            Decline
          </button>
          <button
