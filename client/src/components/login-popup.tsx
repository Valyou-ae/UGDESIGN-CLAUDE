        ...
        <div className="p-8 flex flex-col">
          ...
          {emailSent ? (
            <div className="text-center space-y-4">
              <div className="w-16 h-16 bg-[#F5A623]/20 rounded-full flex items-center justify-center mx-auto">
            ...
            <div className="space-y-5">
              ...
              <form onSubmit={handleEmailSubmit} className="space-y-4">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-12 h-12 bg-[#1a1a1a] border-[#333] text-white placeholder:text-gray-500 rounded-xl focus:border-[#F5A623] focus:ring-1 focus:ring-[#F5A623] transition-all"
                ...
                <Button
                  ...
                  className="w-full h-12 bg-gradient-to-r from-[#F5A623] to-[#B8860B] hover:from-[#d94777] hover:to-[#8B1FA8] text-white font-semibold rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-[#F5A623]/30"
              ...
              <p className="text-xs text-center text-gray-500 pt-2">
                ...
                <a href="/help" className="text-[#F5A623] hover:underline">
                  Terms
                </a>{" "}
                and{" "}
                <a href="/help" className="text-[#F5A623] hover:underline">
