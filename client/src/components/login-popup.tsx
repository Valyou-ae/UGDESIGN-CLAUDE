        ...
        <div className="p-8 flex flex-col">
          ...
          {emailSent ? (
            <div className="text-center space-y-4">
              <div className="w-16 h-16 bg-[#f8991c]/20 rounded-full flex items-center justify-center mx-auto">
              ...
              <Button
                ...
                className="text-[#f8991c] hover:text-[#f8991c]/80 hover:bg-[#f8991c]/10"
              >
            ...
            <div className="space-y-5">
              ...
              <form onSubmit={handleEmailSubmit} className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full h-12 bg-gradient-to-r from-[#f8991c] to-[#B8860B] hover:from-[#d94777] hover:to-[#8B1FA8] text-white font-semibold rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-[#f8991c]/30"
